						...
						<ul id="submenu_deep_dives">
							...
							<li id="deep_dives_maths"><span class="menuTitle">3D geometry</span> <span class="menuSummary menuSummarySubmenu">Pitch angles, yaw angles and coordinates</span>
								<ul id="submenu_deep_dives_3d_geometry">
									...
									<li><a id="deep_dives_3d_geometry_converting_angles_to_coordinates" href="/deep_dives/converting_angles_to_coordinates.html"><span class="menuTitle">Converting angles to coordinates</span> <span class="menuSummary">Using two-triangle maths to convert between angles and Cartesian coordinates</span></a></li>
									<li><a id="deep_dives_3d_geometry_converting_coordinates_to_angles" href="/deep_dives/converting_coordinates_to_angles.html"><span class="menuTitle">Converting coordinates to angles</span> <span class="menuSummary">How to get angles from coordinates using an arctangent lookup table</span></a></li>
									<li><a id="deep_dives_3d_geometry_calculating_the_hypotenuse" href="/deep_dives/calculating_the_hypotenuse.html"><span class="menuTitle">Calculating the hypotenuse</span> <span class="menuSummary">Working out the longest side with just one lookup and one multiplication</span></a></li>
									<li><a id="deep_dives_3d_geometry_trigonometry_in_8-bit_assembly" href="/deep_dives/trigonometry_in_8-bit_assembly.html"><span class="menuTitle">Trigonometry in 8-bit assembly</span> <span class="menuSummary">A look at the various ways in which The Sentinel implements trigonometry</span></a></li>
							...
							<li id="deep_dives_maths"><span class="menuTitle">3D objects</span> <span class="menuSummary menuSummarySubmenu">Trees, boulders, robots and various 3D enemies</span>
								<ul id="submenu_deep_dives_3d_objects">
									...
									<li><a id="deep_dives_3d_objects_calculating_angles_for_drawing_3d_objects" href="/deep_dives/calculating_angles_for_drawing_3d_objects.html"><span class="menuTitle">Calculating angles for drawing 3D objects</span> <span class="menuSummary">The trigonometry that converts 3D object definitions into on-screen polygons</span></a></li>
									<li><a id="deep_dives_3d_objects_drawing_3d_objects" href="/deep_dives/drawing_3d_objects.html"><span class="menuTitle">Drawing 3D objects</span> <span class="menuSummary">How complex 3D objects are drawn using different phases</span></a></li>
								</ul>
							</li>
							...
							<li id="deep_dives_maths"><span class="menuTitle">Drawing the landscape</span> <span class="menuSummary menuSummarySubmenu">How the undulating tile landscape is drawn</span>
								<ul id="submenu_deep_dives_drawing_the_landscape">
									...
									<li><a id="deep_dives_drawing_the_landscape_ray-casting_for_the_tile_visibility_table" href="/deep_dives/ray-casting_for_the_tile_visibility_table.html"><span class="menuTitle">Ray-casting for the tile visibility table</span> <span class="menuSummary">The pre-populated tile visibility table that helps speed up landscape drawing</span></a></li>
