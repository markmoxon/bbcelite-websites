...
switch ($SERVER_NAME) {
	...
	case 'www.markmoxon.com':
	case 'dev.markmoxon.com':
		$DOMAIN = "www.markmoxon.com";
...
function page_header($folder, $name, $meta_title, $title, $description, $page_type = "", $page_parameter1 = "", $page_parameter2 = "", $subtitle = "") {
	...
	if (str_starts_with($page_type, 'aviator')) {
		...
		$twitter_image = 'https://www.markmoxon.com/images/github/github-social-preview.png';		
	} elseif (str_starts_with($page_parameter1, 'cassette_') || str_starts_with($page_parameter2, 'cassette_')) {
		$twitter_image = 'https://www.bbcelite.com/images/cassette/github-social-preview.png';
	} elseif (str_starts_with($page_parameter1, 'disc_') || str_starts_with($page_parameter2, 'disc_')) {
		$twitter_image = 'https://www.bbcelite.com/images/disc/github-social-preview.png';
	} elseif (str_starts_with($page_parameter1, 'electron_') || str_starts_with($page_parameter2, 'electron_')) {
		$twitter_image = 'https://www.bbcelite.com/images/electron/github-social-preview.png';
	} elseif (str_starts_with($page_parameter1, 'master_') || str_starts_with($page_parameter2, 'master_')) {
		$twitter_image = 'https://www.bbcelite.com/images/master/github-social-preview.png';
	} elseif (str_starts_with($page_parameter1, 'elite-a_') || str_starts_with($page_parameter2, 'elite-a_')) {
		$twitter_image = 'https://www.bbcelite.com/images/elite-a/github-social-preview.png';
	} elseif (str_starts_with($page_parameter1, 'sp_') || str_starts_with($page_parameter2, 'sp_')) {
		$twitter_image = 'https://www.bbcelite.com/images/6502sp/github-social-preview.png';
	} elseif (str_starts_with($page_parameter1, 'nes_') || str_starts_with($page_parameter2, 'nes_')) {
		$twitter_image = 'https://www.bbcelite.com/images/nes/github-social-preview.png';
	...
	<body<?php echo $body_class ?>>
		<div id="page-wrapper">
			...
			<div id="navDropdown">
				...
				<p><a href="https://www.markmoxon.com">Mark Moxon's Software Archaeology</a></p>
				<p><a href="https://www.bbcelite.com">Elite on the BBC Micro and NES</a></p>
